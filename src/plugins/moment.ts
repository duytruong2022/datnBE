...
declare module 'moment' {
    interface Moment {
         ...
         * @return string
         */
        fmHourMinuteSecondString(): string;
        /**
         * format DD-MM
         * @return string
         */
...
moment.fn.fmP6FullTimeString = function (): string {
...
moment.fn.fmHourMinuteSecondString = function (): string {
